...
NEXT_PUBLIC_USE_MOCK_API=true   # use public/mocks copied from samples/ until API is ready
```

Point `NEXT_PUBLIC_USE_MOCK_API=false` and set `NEXT_PUBLIC_API_URL` to the deployed backend URL at integration time.
